...
public class Robot extends IterativeRobot {
    ...
    DigitalInput LeftHookSwitch;
    DigitalInput RightHookSwitch;
    
    DoubleSolenoid leftSole, rightSole;
    ...
    public void robotInit() {
        ...
        LeftHookSwitch = new DigitalInput(6);
        RightHookSwitch = new DigitalInput(7);
        //LeftHookSwitch = new DigitalInput(2);
        //RightHookSwitch = new DigitalInput(3);
        ...
        leftSole = new DoubleSolenoid(1, 2);
        rightSole = new DoubleSolenoid(3, 4);
    ...
    //Should drive to obstacle
     ...
     case moat: 
    	 ...
    	 else if(gyro.getAngle() < -9 && autonLoop == 2){
    		 autonDrive(-.7);
    		 autonLoop = 3;
    		 hawk.setPosition(0);
    	 }
    	 else if(hawk.getPosition() < -20000){
    		 autonDrive(0);
    	 }
    	 /**if(hawk.getPosition() > -driveToObstacle && autonLoop == 1){
    		 autonDrive(-.3);
     ...
     case rockWall:
    	 ...
    	 else if(gyro.getAngle() < -15 && autonLoop == 2){
    		 autonLoop = 3;
    		 autonDrive(-.8);
    		 hawk.setPosition(0);
    	 }
    	 else if(hawk.getPosition() < -18000){
    		 autonDrive(0);
    	 }
    ...
    public void teleopPeriodic() {	
    	...
    	SmartDashboard.putNumber("AutonLoop", autonLoop);
    	SmartDashboard.putBoolean("Left Hook", !LeftHookSwitch.get());
    	SmartDashboard.putBoolean("Right Hook", !RightHookSwitch.get());
